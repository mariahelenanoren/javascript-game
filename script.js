...
const actions = [
  ...
  (lightAnotherMatch = {
    description:
      'I light another match.<br>I can still only see the string in front of me.<br>I am out of matches.',
    choices: ['Pull string'],
    nextScene: [5],
  }),
  /* index 4 */
  (keepFumbling = {
    description:
      'I keep fumbling around in the dark.<br>I can feel a string infront of me.',
  ...
  (pullString = {
    description:
      'I pull the string.<br>The light comes on. I am in a cabin.<br>I can see a window, a door, a fireplace<br>and a table with some things on it.',
    choices: [],
    nextScene: [],
  }),
  /* index 6 */
  (theWindow = {
    description:
      'I look out.<br>There is snow as far as the eye can see.<br>The window is frosty.',
  ...
  (theFireplace = {
    description:
      'The cabin is cold.<br>There is firewood next to the fireplace.',
  ...
  (theTable = {
    description:
      'The table seems tattered.<br>On it lays a newspaper,<br>a key, guestbook and a pen.',
    choices: [],
    nextScene: [],
  }),
  /* index 10 */
  ...
  (turningHandleNoKey = {
    description:
      'The door seems to be locked.<br>Perhaps there is a key somewhere.',
    choices: [],
    nextScene: [],
  }),
  /* index 12 */
  (turningHandleRightKey = {
    description:
      'I try the silver key.<br>It fits in the lock.<br>The door is now open.',
  ...
  (theNewspaper = {
    description:
      'The paper has the date October 17, 1962.<br>The New York Yankees defeated the<br>San Fransisco Giants in the world series.',
    choices: [],
    nextScene: [],
  }),
  /* index 15 */
  ...
  (theGuestbook = {
    description:
      'The newest entry is from 1962.<br>It was signed by Walter Buck.',
  ...
  (signTheGuestbook = {
    description:
      "Should I really sign my real name,<br> I still don't know how I got here...",
    choices: ['Done'],
    nextScene: [16],
  }),
  /* index 19 */
  (putWood = {
    description:
      'I put a couple of logs in the fireplace.<br>Underneath there lays a silver key.',
  ...
  (leavingTheCabin = {
    description:
      'The air feels cool and crisp.<br>Snow is still the only thing in sight.<br>I wonder where I go from here...',
    choices: ['Play again'],
    nextScene: [0],
  }),
];
...
function showAllOptionButtons() {
  button[0].style.display = 'unset';
  button[1].style.display = 'unset';
  buttonWrapper.style.display = 'flex';
}

function showOneOptionButton() {
  hideElement(button[1]);
  button[0].style.display = 'unset';
  buttonWrapper.style.display = 'flex';
}

function hideAllOptionButtons() {
  hideElement(button[0]);
  hideElement(button[1]);
...
function changeScene(answer) {
  ...
  } else if (answer === 'The window') {
    currentScene = 6;
    hideElement(secondaryMenu);
...
function defrostWindow() {
  actions[8].description =
    'The fire is burning.<br>The cabin is slowly getting warmer.';
  actions[8].choices = [];
  actions[8].nextScene = [];
  actions[6].description =
    'I look out.<br>There is snow as far as the eye can see.';
  actions[6].choices = [];
  actions[6].nextScene = [];
  changeDescription();
  changeButtons();
...
function changeFireplaceScene() {
  actions[8].description =
    'I have no matches to light the fireplace with.<br>The cabin is cold.';
  actions[8].choices = [];
  actions[8].nextScene = [];
  changeDescription();
  changeButtons();
...
function openingDoorNoKeys() {
  actions[22].description =
    "The door is locked.<br>Perhaps there's a key somewhere.";
  actions[22].choices = [];
